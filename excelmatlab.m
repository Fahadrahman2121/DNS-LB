...
clear
Query=0:40;
Average_mins_arrivals=2.65;
mins_between_arrivals=0:19;
Cumulative_prob=1-poisscdf(Average_mins_arrivals,mins_between_arrivals);
...
Time_btw_arrivals(i)=mins_between_arrivals(indice);
end
...
ALEA2=rand(1,1);
   if max(End_shared1)<max(End_shared2)
    ...
    Time2(i)=fix(-1*Average_mins_cust*log(ALEA2));
